#
# Supermarine Swift FR5 External stores 
# ---------------------------
# Manages the external stores; pylons etc.
# ---------------------------
# Taeke van den Bosch - based on F-15 version by Richard Harrison

var ExtTanks = props.globals.getNode("sim/model/Supermarine-Swift/systems/external-loads/external-tanks");
var WeaponsSet = props.globals.getNode("sim/model/Supermarine-Swift/systems/external-loads/external-load-set");
var WeaponsWeight = props.globals.getNode("sim/model/Supermarine-Swift/systems/external-loads/weapons-weight", 1);
var PylonsWeight = props.globals.getNode("sim/model/Supermarine-Swift/systems/external-loads/pylons-weight", 1);
var TanksWeight = props.globals.getNode("sim/model/Supermarine-Swift/systems/external-loads/tankss-weight", 1);
var S0 = nil;
var S1 = nil;
var S2 = nil;
var S3 = nil;
...
var ext_loads_dlg = gui.Dialog.new("dialog","Aircraft/Supermarine-Swift/gui/dialogs/external-loads.xml");
Station =
{
	new : func (number)
    {
		var obj = {parents : [Station] };
		obj.prop = props.globals.getNode("sim/model/SwiftFR5/systems/external-loads/").getChild ("station", number , 1);
		obj.index = number;
...
var toggle_ext_tank_selected = func() {
	...
	if ( ext_tanks ) {
		...
		S2.set_weight_lb(100);            # lbs, empty tank weight.

		Left_External.set_level(256.7);     # US gals, tank fuel contents.
...
var droptanks = func(n) {
	if (wow) { setprop("sim/model/Supermarine-Swift/controls/armament/tanks-ground-sound", 1) }
	var droptank = droptank_node.getValue();
	var node = props.globals.getNode(n.getValue(), 1);
	geo.put_model("Aircraft/Supermarine-Swift/Models/Stores/Ext-Tanks/exttank-submodel.xml",
