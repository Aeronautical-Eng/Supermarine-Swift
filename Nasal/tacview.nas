...
### Parameters to adjust (example values from the SwiftFR5)

# Aircraft type string for tacview
var tacview_ac_type = getprop("sim/variant-id") < 3 ? "Supermarine-Swift" : "Supermarine-Swift";
# Aircraft type as inserted in the output file name
var filename_ac_type = "Supermarine-Swift";
